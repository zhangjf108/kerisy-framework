 ...
 * @since 2.0
 */
abstract class BaseActiveRecord extends Object implements ActiveRecordInterface
{
    /**
     ...
     * @throws \Kerisy\Core\InvalidParamException if relation name is wrong
