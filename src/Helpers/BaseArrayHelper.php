...
class BaseArrayHelper
{
     ...
     * ~~~
     * // working with array
     * $username = \Kerisy\Helpers\ArrayHelper::getValue($_POST, 'username');
     * // working with object
     * $username = \Kerisy\Helpers\ArrayHelper::getValue($user, 'username');
     * // working with anonymous function
     * $fullName = \Kerisy\Helpers\ArrayHelper::getValue($user, function ($user, $defaultValue) {
     *     return $user->firstName . ' ' . $user->lastName;
     * });
     * // using dot format to retrieve the property of embedded object
     * $street = \Kerisy\Helpers\ArrayHelper::getValue($users, 'address.street');
     * ~~~
     *
     ...
     * // working with array
     * $type = \Kerisy\Helpers\ArrayHelper::remove($array, 'type');
     * // $array content
     * // $array = ['options' => [1, 2]];
     * ~~~
     *
